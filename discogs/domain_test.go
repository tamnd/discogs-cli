...
// HTTP behaviour is covered in discogs_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "discogs://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("discogs", "about")
	if err != nil || got.String() != "discogs://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want discogs://page/about", got.String(), err)
	}
}
