...
Most of these come down to network reality or how discogs serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

discogs rate-limits like any public site. discogs already paces
...
Where a surface is gated, discogs reads a cookie or token you supply
...
`discogs`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what discogs actually did
